...
const AIResponsePreview = ({ content }) => {
	...
	return (
		<div className="max-w-4xl mx-auto">
			<div className="text-[16px] prose prose-slate dark:prose-invert max-w-none">
				<ReactMarkdown
	...
	return (
		<div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
			<div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
				...
				<button onClick={copyCode} className="flex items-center justify-center text-gray-500 hover:text-gray-700 focus:outline-none relative group" aria-label="Copy code">
					{copied ? (
			...
			<SyntaxHighlighter language={language} style={oneLight} customStyle={{ fontSize: 14, margin: 0, padding: '1rem', background: 'transparent' }}>
				{code}
			</SyntaxHighlighter>
		</div>
	);
